<?php
	if (isset($_POST["icc-btn-pseudo"])) {
		$e_pseudo = $_POST["icc-text-pseudo"];
		if ($e_pseudo != null) {
		...
		$e_adminGrade = $_POST["icc-text-adminGrade"];
		...
		$e_bannir = $_POST["icc-text-bannir"];
		...
		$e_rebannir = $_POST["icc-text-bannir"];
		if ($e_rebannir != null) {
		...
		$e_mailShow = $_POST["icc-text-mailShow"];
		if ($e_mailShow != null) {
		...
		$e_status = $_POST["icc-text-status"];
		if ($e_status != null) {
